<script>
  ...
  let generalModelValue = $state("");
  function handleModelChange() {
    if (generalModelValue.includes("gemini")) {
      settings.currentModelProvider = "gemini";
      settings.gemini.geminiModelValue = generalModelValue;
      console.log("currentModelProvider", currentModelProvider);
    } else if (generalModelValue.includes("fireworks")) {
      settings.currentModelProvider = "fireworks";
      settings.fireworks.fireworksModelValue = generalModelValue;
      console.log("currentModelProvider", currentModelProvider);
    } else {
      settings.currentModelProvider = "groq";
      settings.groq.groqModelValue = generalModelValue;
      console.log("currentModelProvider", currentModelProvider);
    }
  }
